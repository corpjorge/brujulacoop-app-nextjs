                ...
                <div class="col-lg-6">
                    <div class="signup-content-wrapper">
                        <div class="section-title">
                            ...
                            <p>
                                Ingresa tu número de cédula y participa para
                                ganar increíbles premios.
                            </p>
                        </div>
                        <div class="image">
                            <img
...
export default {
    ...
    methods: {
        login() {
            axios
                .post("/login", { document: this.document, password: "123" })
                .then(response => {
                ...
                .catch(errors => {
                    ...
                    if (this.show === "Too Many Attempts.") {
                        return;
                    }
